...
const enPages: Record<string, ServicePageContent> = {
  ...
  "contabil-srl-sibiu": {
    ...
    metaTitle:
      "LLC Accountant in Sibiu | English-Speaking Accounting",
    metaDescription:
  ...
  "infiintare-firma-sibiu": {
    ...
    metaTitle:
      "Company Formation in Sibiu | Start a Business in Romania",
    metaDescription:
    ...
    bullets: [
      ...
      "Explanation of first steps and required documents (registrations, stamps, bank accounts), with translation when needed.",
  ...
  "consultanta-fiscala-sibiu": {
    ...
    metaTitle:
      "Tax Advisory in Sibiu | English-Speaking Tax Support",
    metaDescription:
    ...
    intro:
      "Good tax advisory means knowing in advance which taxes are coming, what a decision changes, and how to avoid unpleasant surprises—especially if you’re not familiar with Romania’s tax system. We offer English‑speaking tax advisory services in Sibiu and explain Romanian and EU tax rules to foreign and local businesses.",
    summary:
      "We provide practical tax clarification that fits the real activity of your business—covering Romanian tax, EU VAT, double‑taxation agreements, and cross‑border issues—so you can make informed decisions.",
    bullets: [
      "Clarification before important decisions, including cross‑border transactions and restructuring.",
      "Simple explanations about upcoming tax obligations (profit tax, microtax, social contributions).",
      "Support for inspections, SAF‑T reporting, RO e‑Factura, and representation before ANAF, with translation for foreign directors.",
  ...
  "salarizare-sibiu": {
    ...
    metaTitle:
      "Payroll Services in Sibiu | English-Speaking Payroll Support",
    metaDescription:
    ...
    summary:
      "We manage payroll and personnel documents so the process remains reliable, orderly, and on time, while ensuring you comply with Romanian labour law and social contributions for both local and foreign staff.",
    bullets: [
      "Salary calculations and personnel documents prepared correctly, with explanations of Romanian payroll requirements.",
      "Tracking deadlines and obligations related to payroll taxes and social contributions.",
      "Support for team changes and day‑to‑day clarifications, including hiring expats or remote workers.",
...
export const servicePageSlugs = {
  ro: Object.keys(roPages),
  en: Object.keys(enPages),
};
